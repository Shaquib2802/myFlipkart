...
const Signup = () => {
  return (
    <div className="w-[100vw] h-[100vh] bg-gray-200 overflow-hidden">
      <form className="w-[80%] h-[95%] border-black   m-auto flex mt-3 ">
        <div className="w-[50%] bg-white flex flex-col ">
          <div className="ml-12 w-32  h-20    overflow-hidden">
            <img
          ...
          <div className=" text-xl flex font-semibold justify-center  mt-12 ml-12">
